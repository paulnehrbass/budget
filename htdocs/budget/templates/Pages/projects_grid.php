                                            ...
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-1.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-2.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-3.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-4.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-5.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <div class="avatar-md">
                                                    <span class="avatar-title rounded-circle bg-light text-danger font-size-16">
                                                        <img src="/budget/images/companies/img-6.png" alt="" height="30">
                                                    </span>
                                                </div>
                                            </div>
