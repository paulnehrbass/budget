        ...
        <nav class="navbar navbar-expand-lg navigation fixed-top sticky">
            <div class="container">
                <a class="navbar-logo" href="home">
                    <img src="/budget/images/logo-dark.png" alt="" height="19" class="logo logo-dark">
                    <img src="/budget/images/logo-light.png" alt="" height="19" class="logo logo-light">
                </a>
                        ...
                        <div class="owl-carousel owl-theme clients-carousel" id="clients-carousel" dir="ltr">
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/1.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/2.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/3.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/4.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/5.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                            <div class="item">
                                <div class="client-images">
                                    <img src="/budget/images/clients/6.png" alt="client-img" class="mx-auto img-fluid d-block">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center pt-4">
                    <div class="col-md-6 col-sm-8">
                        <div>
                            <img src="/budget/images/crypto/features-img/img-1.png" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                ...
                <div class="row align-items-center mt-5 pt-md-5">
                    ...
                    <div class="col-md-6  col-sm-8 ms-md-auto">
                        <div class="mt-4 me-md-0">
                            <img src="/budget/images/crypto/features-img/img-2.png" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    ...
                    <div class="owl-carousel owl-theme events navs-carousel" id="team-carousel" dir="ltr">
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="/budget/images/users/avatar-2.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="/budget/images/users/avatar-3.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="/budget/images/users/avatar-8.jpg" alt="" class="rounded">
                                    </div>
                                    <div class="mt-3">
                                        <h5>Vickie Sample</h5>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="/budget/images/users/avatar-5.jpg" alt="" class="rounded">
                                    </div>
                        ...
                        <div class="item">
                            <div class="card text-center team-box">
                                <div class="card-body">
                                    <div>
                                        <img src="/budget/images/users/avatar-1.jpg" alt="" class="rounded">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="position-relative">
                                <img src="/budget/images/crypto/blog/img-1.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            ...
                            <div class="position-relative">
                                <img src="/budget/images/crypto/blog/img-2.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                                <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                            </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="blog-box mb-4 mb-xl-0">
                            <div class="position-relative">
                                <img src="/budget/images/crypto/blog/img-3.jpg" alt="" class="rounded img-fluid mx-auto d-block">
                                <div class="badge bg-success blog-badge font-size-11">Cryptocurrency</div>
                            </div>
        ...
        <footer class="landing-footer">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <img src="/budget/images/logo-light.png" alt="" height="20">
                        </div>
