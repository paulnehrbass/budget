                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="home" class="d-block auth-logo">
                                            <img src="/budget/images/logo-dark.png" alt="" height="18" class="auth-logo-dark">
                                            <img src="/budget/images/logo-light.png" alt="" height="18" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" action="home">
                                                ...
                                                <div class="user-thumb text-center mb-4">
                                                    <img src="/budget/images/users/avatar-1.jpg" class="rounded-circle img-thumbnail avatar-md" alt="thumbnail">
