                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="home" class="d-block auth-logo">
                                            <img src="/budget/budget/images/logo-dark.png" alt="" height="18" class="auth-logo-dark">
                                            <img src="/budget/budget/images/logo-light.png" alt="" height="18" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
