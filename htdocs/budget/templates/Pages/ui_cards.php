                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row" data-masonry='{"percentPosition": true }'>
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="card">
                                            <img src="/budget/images/small/img-3.jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="card">
                                            <img src="/budget/images/small/img-5.jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="card">
                                            <img src="/budget/images/small/img-7.jpg" class="card-img-top" alt="...">
                                        </div>
                                    </div>
