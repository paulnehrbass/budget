                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="card p-1 border shadow-none">
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <img src="/budget/images/small/img-2.jpg" alt="" class="img-thumbnail">
                                                                        </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="card p-1 border shadow-none">
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <img src="/budget/images/small/img-6.jpg" alt="" class="img-thumbnail">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="card p-1 border shadow-none">
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <img src="/budget/images/small/img-1.jpg" alt="" class="img-thumbnail">
                                                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="list-group list-group-flush">
                                                ...
                                                <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-3">
                                                            <img src="/budget/images/small/img-7.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                        </div>
                                                ...
                                                <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-3">
                                                            <img src="/budget/images/small/img-4.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                        </div>
                                                        <div class="flex-grow-1 overflow-hidden">
