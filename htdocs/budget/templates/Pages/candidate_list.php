    ...
    <?= $this->element('body') ?>
        ...
        <div id="layout-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Jobs', 'title' => 'Candidate List')) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-1.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-6.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-7.jpg" alt="" class="avatar-sm rounded-circle" />
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/users/avatar-8.jpg" alt="" class="avatar-sm rounded-circle" />
