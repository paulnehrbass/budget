    ...
    <?= $this->element('body') ?>
        ...
        <div id="layout-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <!-- $this->element('page-title', array('pagetitle' => 'Dashboards', 'title' => 'Job')) -->

                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <div class="d-flex align-items-center">
                                    <img src="/budget/images/users/avatar-1.jpg" alt="" class="avatar-sm rounded">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <img src="/budget/images/jobs.png" alt="" height="130">
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end card-->
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active" data-bs-interval="3000">
                                                    <div class="bg-light p-3 d-flex mb-3 rounded">
                                                        <img src="/budget/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="bg-light p-3 d-flex">
                                                        <img src="/budget/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="carousel-item" data-bs-interval="3000">
                                                    <div class="bg-light p-3 d-flex mb-3 rounded">
                                                        <img src="/budget/images/users/avatar-1.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                                                    ...
                                                    <div class="bg-light p-3 d-flex">
                                                        <img src="/budget/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded me-3">
                                                        <div class="flex-grow-1">
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/airbnb.svg" alt="" class="avatar-sm">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/mailchimp.svg" alt="" class="avatar-sm">
                                            <a href="job-details" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/reddit.svg" alt="" class="avatar-sm">
                                            <a href="job-details" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/amazon.svg" alt="" class="avatar-sm">
                                            <a href="job-details" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/adobe-photoshop.svg" alt="" class="avatar-sm">
                                            <a href="job-details" class="text-body">
                            ...
                            <div class="col-lg-2">
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class="text-center mb-3">
                                            <img src="/budget/images/companies/line.svg" alt="" class="avatar-sm">
                                            <a href="job-details" class="text-body">
                                        ...
                                        <div data-simplebar style="max-height: 376px;">
                                            <ul class="verti-timeline list-unstyled">
                                                <li class="event-list">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <img src="/budget/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <div>
                                                ...
                                                <li class="event-list">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 me-3">
                                                            <img src="/budget/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div data-simplebar style="max-height: 376px;">
                                            <div class="vstack gap-4">
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/wechat.svg" alt="" height="40" class="rounded">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/sass.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/adobe.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/airbnb.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/flutter.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/mailchimp.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                        <h6 class="mb-1 font-size-15"><a href="job-details" class="text-body">Marketing Director</a></h6>
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/spotify.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
                                                ...
                                                <div class="d-flex">
                                                    <img src="/budget/images/companies/reddit.svg" alt="" height="40" class="rounded">
                                                    <div class="ms-2 flex-grow-1">
