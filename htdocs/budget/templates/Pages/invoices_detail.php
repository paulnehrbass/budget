                                    ...
                                    <div class="card-body">
                                        <div class="invoice-title">
                                            ...
                                            <div class="auth-logo mb-4">
                                                <img src="/budget/images/logo-dark.png" alt="logo" class="auth-logo-dark" height="20"/>
                                                <img src="/budget/images/logo-light.png" alt="logo" class="auth-logo-light" height="20"/>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
