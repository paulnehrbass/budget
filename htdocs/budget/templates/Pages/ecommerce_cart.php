                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap">
                                                ...
                                                <tbody>
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-1.png" alt="product-img"
                                                    ...
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-2.png" alt="product-img"
                                                                title="product-img" class="avatar-md" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-3.png" alt="product-img"
                                                                title="product-img" class="avatar-md" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-4.png" alt="product-img"
                                                                title="product-img" class="avatar-md" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-5.png" alt="product-img"
                                                                title="product-img" class="avatar-md" />
                                                        </td>
                                                        <td>
                                                            <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail" class="text-dark">Half sleeve T-Shirt</a></h5>
                                                    ...
                                                    <tr class="product">
                                                        <td>
                                                          <img src="/budget/images/product/img-6.png" alt="product-img"
                                                                title="product-img" class="avatar-md" />
                                                        </td>
                                                        <td>
