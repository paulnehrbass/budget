                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <img src="/budget/images/companies/img-1.png" alt="" class="avatar-sm">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 50px;"><img src="/budget/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/budget/images/users/avatar-1.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/budget/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt=""></td>
