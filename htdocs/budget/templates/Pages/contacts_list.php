<?= $this->element('main') ?>
    ...
    <?= $this->element('body') ?>
                                        ...
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <div class="avatar-lg">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="/budget/images/users/user-dummy-img.jpg" id="member-img" class="avatar-md rounded-circle h-auto" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="/js/pages/contact-user-list.init.js"></script>
        <!-- App js -->
