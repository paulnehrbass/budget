<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Candidate Overview')) ?>
    ...
    <?= $this->element('body') ?>
        ...
        <div id="layout-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <!-- $this->element('page-title', array('pagetitle' => 'Jobs', 'title' => 'Candidate Overview')) -->
                                ...
                                <div class="card mx-n4 mt-n4 bg-info-subtle">
                                    <div class="card-body">
                                        <div class="text-center mb-4">
                                            <img src="/budget/images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle mx-auto d-block" />
