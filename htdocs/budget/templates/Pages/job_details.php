<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Job Details')) ?>
    ...
    <?= $this->element('body') ?>
        ...
        <div id="layout-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Jobs', 'title' => 'Job Details')) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            <img src="/budget/images/companies/adobe-photoshop.svg" alt="" height="50" class="mx-auto d-block">
                            ...
                            <div class="col-xl-9">
                                <div class="card">
                                    <div class="card-body border-bottom">
                                        <div class="d-flex">
                                            <img src="/budget/images/companies/wechat.svg" alt="" height="50">
