                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-4 align-self-center">
                                                <div>
                                                    <img src="/budget/images/crypto/features-img/img-1.png" alt="" class="img-fluid d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar-xs">
                                                            <span class="avatar-title rounded-circle bg-light">
                                                                <img src="/budget/images/companies/img-1.png" alt="" height="18">
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item border-0">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar-xs">
                                                            <span class="avatar-title rounded-circle bg-light">
                                                                <img src="/budget/images/companies/img-2.png" alt="" height="18">
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item border-0">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar-xs">
                                                            <span class="avatar-title rounded-circle bg-light">
                                                                <img src="/budget/images/companies/img-3.png" alt="" height="18">
                                                            </span>
                                                        </div>
                                                    </div>
