...
$(document).ready(function () {
    ...
    $("#addtask").click(function(){
        ...
        for (i = 0; i < taskassignee.length; i++) {
            src=src+'<div class="avatar-group-item"><a href="#" class="d-inline-block" value="'+taskassigneevalue[i]+'"><img src="/budget'+taskassignee[i]+'" class="rounded-circle avatar-xs" alt=""></a></div>';
        }
        var statuscolor;
