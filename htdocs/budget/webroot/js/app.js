...
(function ($) {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "/budget/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "/budget/images/flags/spain.jpg";
            }
            else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "/budget/images/flags/germany.jpg";
            }
            else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "/budget/images/flags/italy.jpg";
            }
            else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "/budget/images/flags/russia.jpg";
            }
    ...
    function updateThemeSetting(id) {
        if ($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch") {
            ...
            if($("#bootstrap-style").attr('href') != '/css/bootstrap.min.css')
                $("#bootstrap-style").attr('href', '/css/bootstrap.min.css');
            $('html').attr('data-bs-theme', 'light');
            if($("#app-style").attr('href') != '/css/app.min.css')
            ...
            $("#dark-mode-switch").prop("checked", false);
            $("#dark-rtl-mode-switch").prop("checked", false);
            if($("#bootstrap-style").attr('href') != '/css/bootstrap-rtl.min.css')
                $("#bootstrap-style").attr('href', '/css/bootstrap-rtl.min.css');
            if($("#app-style").attr('href') != '/css/app-rtl.min.css')
